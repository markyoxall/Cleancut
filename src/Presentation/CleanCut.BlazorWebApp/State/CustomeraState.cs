...
public class CustomeraState : ICustomersState
{
    private readonly ICustomerApiService _customerApi;
    private readonly ILogger<CustomeraState> _logger;
    ...
    public CustomeraState(ICustomerApiService customerApi, ILogger<CustomeraState> logger)
    {
