...
Ensure-Dir $faDir
Download-File "https://unpkg.com/font-awesome@$faVersion/css/font-awesome.min.css" (Join-Path $faDir "css\font-awesome.min.css")
# Download fonts referenced by the CSS
$faFonts = @("fonts/fontawesome-webfont.woff2", "fonts/fontawesome-webfont.woff", "fonts/fontawesome-webfont.ttf", "fonts/fontawesome-webfont.eot")
foreach ($f in $faFonts) {
    Download-File "https://unpkg.com/font-awesome@$faVersion/$f" (Join-Path $faDir $f)
}
